...
class TestMaksukortti(unittest.TestCase):
    ...
    def test_kortilla_voi_ostaa_edullisen_lounaan_kun_saldo_edullisen_lounaan_verran(
        self,
    ):
    ...
    def test_kortilla_voi_ostaa_maukkaan_lounaan_kun_saldo_maukkaan_lounaan_verran(
        self,
    ):
